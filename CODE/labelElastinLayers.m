...
for k=1:numEndPoints
    outputLayersPoints          = insertText(outputLayersPoints,[ elastinEndPoints_P(k).Centroid(1),elastinEndPoints_P(k).Centroid(2)],num2str(k),FontSize=70,BoxOpacity=0.2,TextColor='black',TextBoxColor='white');
end
